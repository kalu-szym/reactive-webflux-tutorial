...
import com.ourcastle.reactivewebfluxtutorial.config.SecurityConfig;
...
@SpringJUnitConfig({WebConfig.class, SecurityConfig.class})
@WebFluxTest(controllers = ProductController.class)
public class TestProductControllerBindToController {
    ...
    public class TestProductControllerWebTestClient {
        ...
        @BeforeEach
        void setUp() {
            webClient = WebTestClient.bindToController(new ProductController(productDaoImp)).build();
        }
